<nav class="bg-gray-800">
            ...
            <div class="flex h-16 items-center justify-between">
                ...
                <div class="hidden md:block">
                    ...
                    <a href="/" class="<?= urlIs('/') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white'?> rounded-md px-3 py-2 text-sm font-medium" aria-current="page">Homepage</a>
                ...
                <div class="ml-4 flex items-center md:ml-6">
                    ...
                    <div>
                        <button onclick="location.href='/register'" type="button" class="relative flex max-w-xs items-center rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                        <span class="absolute -inset-1.5"></span>
