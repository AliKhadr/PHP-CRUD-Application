                ...
                <div class="ml-4 flex items-center md:ml-6">
                    ...
                    <div>
                        <?php if (isset($_SESSION['user'])) : ?>
                            ...
                            <a href="/logout" class="<?= urlIs('/logout') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white'?> ml-2 rounded-md px-3 py-2 text-sm font-medium ">logout</a>
                        <?php else : ?>
